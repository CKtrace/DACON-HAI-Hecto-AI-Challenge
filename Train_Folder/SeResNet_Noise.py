...
class SEResNeXtModel(nn.Module):
    def __init__(self, num_classes):
        super().__init__()
        self.backbone = timm.create_model('seresnextaa101d_32x8d.sw_in12k_ft_in1k', pretrained=True)
...
for epoch in range(CFG['EPOCHS']):
    ...
    if val_logloss < best_logloss:
        ...
        torch.save(model.state_dict(), 'SeResNext_OptunaCutMix_Halfcrop_Noise.pth')
